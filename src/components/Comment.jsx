...
export default function Comment() {
  return (
    ...
    <img className="comment__img--mohan" src={ mohanImage} alt="mohan-image" />
</div>
    <div className="comment__textarea">
    <textarea className="comment__textarea-element" rows="8" cols="50" placeholder="Add a new comment"/>
    <div className="Btn__addComment">
        <img className="Btn__addComment--img" src={addComment} alt="addComment-image" />
    <Btn text="COMMENT" / >
    </div>
    </div>
    </div>
